    ...
    <div className="bg-white rounded-xl shadow-sm py-4 px-3 flex flex-col justify-between h-full">
      <>
        ...
        <div className="flex items-center mb-5">
          <div className="w-11 h-12 mr-2 flex items-center justify-center">
            <FaStar className="text-gray-800 text-2xl oliva-o" />
          </div>
        ...
        <div className="flex items-center mb-5">
          <div className="w-11 h-12 mr-2 flex items-center justify-center">
            <FaUserTie className="text-gray-800 text-2xl oliva-o" />
          </div>
          <div className="w-8/10">
            <p className="font-semibold text-[15px] text-gray-700">
              Profesionalismo
        ...
        <div className="flex items-center mb-4">
          <div className="w-11 h-12 mr-2 flex items-center justify-center">
            <FaClock className="text-gray-800 text-2xl oliva-o" />
          </div>
          <div className="w-8/10">
            <p className="font-semibold text-[15px] text-gray-700">
              Fiabilidad
      ...
      {/* Botón Conózcanos */}
      <button className="w-full bg-oliva-c text-white py-2 rounded-lg font-semibold bg-oliva-o-hover">
        Conózcanos
      </button>
    </div>
  );
